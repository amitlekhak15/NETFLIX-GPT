...
const Secondarycontainer = () => {
  ...
  return (
    <div className=' bg-black'>
        <div  className=' mt-0 md:-mt-40 relative z-20 pl:4 md:pl-12'><MovieList title={" Now Playing"} movies={movies.nowPlayingMovies}/></div>
    ...
    <div><MovieList title={" Horror Movies"} movies={movies.HorrorMovies}/></div>
